...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-12 items-center justify-center rounded-xl bg-gray-800/50 p-1.5 text-gray-400 border border-gray-700/50",
      className
    )}
    {...props}
  />
